...
<html lang="en">
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div class="div">
          <h1><i class="fa fa-laptop"></i> Add Service Type</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="serviceLists">Service Type Lists</a></li>
          <li class="breadcrumb-item"><a href="addServices">Add Service Type</a></li>
        </ul>
      </div>
      <div class="row">
      <div class="col-md-8" style="margin-left:200px;">
        ...
        <div class="card-body1" style="background-color:#009688; height:50px; margin-bottom:5px; border-radius:5px;">
            <h5 class="card-title" align="center" style="color:white; padding:12px;">Add Service Type Form</h5>
        </div>
        </div>
        </div>
        <div class="col-md-8" style="margin-left:200px;">
            ...
            <div class="card-body" >
              ...
              <!-- Horizontal Form -->
              <form:form action="addServiceTypes" modelAttribute="serviceType" id="contactForm" name="contactForm" class="contactForm">
             
                <div class="row mb-5">
                  <label for="inputEmail3" class="col-sm-4 col-form-label" style="font-weight: bold; text-align: center;">Service Type Name</label>
                  <div class="col-sm-8">
                    <form:input path="serviceTypeName" class="form-control" placeholder="Enter Service Type Name" style="background-color:whitesmoke;" required="true"></form:input> 
                  </div>
                 </div>
