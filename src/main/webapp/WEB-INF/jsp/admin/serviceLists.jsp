    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <!-- Button trigger modal -->
          <button type="button" style="margin-top:5px; float: right; margin-left: 150px; margin-bottom:-15px;" class="bg-info text-white"><i class="fa fa-plus-circle" aria-hidden="true"><a href="addServices" style="text-decoration:none; color:white;"> Add Service</a></i></button>                              
                    ...
                    <% int index=1; %>
						<c:forEach var="service" items="${list}">
							<tr align="center">
								...
								<td><a href="editServices/${service.serviceId}" class="settings"
									title="Edit"> <i class="fa fa-edit"></i>
								</a> <a href="deleteService/${service.serviceId}" class="delete" title="Delete"><i
