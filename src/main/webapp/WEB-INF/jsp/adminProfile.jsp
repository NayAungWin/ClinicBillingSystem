    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-8" style="margin-left:200px;">
            <div class="card">
            <div class="card-body" >
              <h5 class="card-title" align="center">Add Admin Form</h5>

              <!-- Horizontal Form -->
              <form:form action="adminProfile" modelAttribute="admin">
                <div class="row mb-3" style="padding:20px;">
                  <label for="inputEmail3" class="col-sm-4 col-form-label" style="font-weight: bold; text-align: center;">Admin Name</label>
                  <div class="col-sm-8">
                    <form:input path="adminName" type="text" class="form-control" id="inputText" style="background-color:whitesmoke;" />
                  </div>
                </div>
                <div class="row mb-3" style="padding:20px;">
                  <label for="inputEmail3" class="col-sm-4 col-form-label" style="font-weight: bold; text-align: center;">Admin Email</label>
                  <div class="col-sm-8">
                    <form:input path="adminEmail" type="email" class="form-control" id="inputText" style="background-color:whitesmoke;" />
                  </div>
                </div>
                <div class="row mb-3" style="padding:20px;">
                  <label for="inputEmail3" class="col-sm-4 col-form-label" style="font-weight: bold; text-align: center;">Admin Password</label>
                  <div class="col-sm-8">
                    <form:input path="adminPassword" type="password" class="form-control" id="inputText" style="background-color:whitesmoke;" />
                  </div>
                </div>
                <div class="row mb-3" style="padding:20px;">
                  <label for="inputEmail3" class="col-sm-4 col-form-label" style="font-weight: bold; text-align: center;">Admin Role</label>
                       <div class="col-sm-8">
	                       <form:select path="adminRole" class="form-control" style="background-color:whitesmoke;">
	                          <option></option>
