    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <button style="margin-top:10px;" class="bg-info text-white"><i class="fa fa-file" aria-hidden="true"><a style="text-decoration:none; color:white;"> Export to excel</a></i></button>
        </div>
        <div class="col-md-4">
