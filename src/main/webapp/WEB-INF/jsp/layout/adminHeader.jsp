      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
          	<li><a class="dropdown-item" href="admin_profile"><i class="fa fa-user fa-lg"></i> Profile</a></li>
            <li><a class="dropdown-item" href="editAdminProfile"><i class="fa fa-pencil-square" aria-hidden="true"></i> Edit Profile</a></li>
            <li><a class="dropdown-item" href="changePassword"><i class="fa fa-unlock-alt" aria-hidden="true" style="font-size:18px;"></i>Change Password</a></li>           
