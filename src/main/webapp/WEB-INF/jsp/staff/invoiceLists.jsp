    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <div class="col-md-4">
          ...
          <button type="button" data-toggle="modal" data-target="#Modal" style="margin-top:5px; float: right; margin-left: 120px; margin-bottom:-20px; width: 80px" class="bg-info text-white"><i class="fa fa-file" aria-hidden="true">&nbsp;&nbsp;Print</i></button>                              
