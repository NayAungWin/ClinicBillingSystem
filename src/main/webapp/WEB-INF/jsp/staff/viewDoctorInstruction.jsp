      ...
      <div class="app-title">
        ...
        <div class="col-md-4">
          <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item"><a href="javascript:history.back()">Doctor Instruction</a></li>
...
<!--          <form:input path="patientId" type="date" class="form-control" value="${instruction.patientId}" hidden="true"></form:input> --> 
          	<div style="float:right;">
                <button type="submit" value="submit" class="btn btn-primary">Create Invoice</button>
